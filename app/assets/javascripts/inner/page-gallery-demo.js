(function(){
  ...
  $(document).on( 'click', '[data-toggle="gallery-sort"]', function(e){
    ...
    $('#vidgallery').mixItUp( 'sort', data.sort);
    $('#gallery2').mixItUp( 'sort', data.sort);
    $('#vidgallery2').mixItUp( 'sort', data.sort);
    $('#gallery3').mixItUp( 'sort', data.sort);
    $('#vidgallery3').mixItUp( 'sort', data.sort);
  })
  .on( 'keyup', '[data-toggle="gallery-filter"]', WrapkitUtils.debounce(function(){
    ...
    $('#vidgallery').mixItUp('filter', target);
    $('#gallery2').mixItUp('filter', target);
    $('#vidgallery2').mixItUp('filter', target);
     $('#gallery3').mixItUp('filter', target);
    $('#vidgallery3').mixItUp('filter', target);
  }, 300))
  .on( 'click', '[data-toggle="gallery-layout"]', function(){
    var isGrid = $('#gallery').hasClass('gallery-grid');
    var isVidGrid = $('#vidgallery').hasClass('gallery-grid');
    var isGrid2 = $('#gallery2').hasClass('gallery-grid');
    var isVidGrid2 = $('#vidgallery2').hasClass('gallery-grid');
    var isGrid3 = $('#gallery3').hasClass('gallery-grid');
    var isVidGrid3 = $('#vidgallery3').hasClass('gallery-grid');
    $('#gallery').toggleClass('gallery-grid gallery-list');

    if (isGrid || isVidGrid || isGrid2 || isVidGrid2) {
  ...
  initPhotoSwipeFromDOM('#vidgallery');
  initPhotoSwipeFromDOM('#gallery2');
  initPhotoSwipeFromDOM('#vidgallery2');
  initPhotoSwipeFromDOM('#gallery3');
  initPhotoSwipeFromDOM('#vidgallery3');
